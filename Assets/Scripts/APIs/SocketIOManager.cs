...
public class SocketIOManager : MonoBehaviour
{
    ...
    // Called from the WebGL/JS focus path only (UIManager.OnFocusChanged) — never from
    // OnApplicationFocus, which isn't reliable enough inside a WebView to gate a socket close.
